	...
	*/
	...
	var UtilsFilterControl = {
	  ...
	  initFilterSelectControls: function initFilterSelectControls(that) {
	    var data = that.records;
	    var itemsPerPage = that.pageTo < that.options.records.length ? that.options.records.length : that.pageTo;
	...
	function (_$$BootstrapTable) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function initSearch() {
	      ...
	      that.data = fp ? that.options.records.filter(function (item, i) {
	        var itemIsExpected = [];
