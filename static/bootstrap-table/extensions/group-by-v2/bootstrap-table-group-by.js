(function (global, factory) {
	...
	*/
	...
	BootstrapTable.prototype.initSort = function () {
	  ...
	  if (this.options.groupBy && this.options.groupByField !== '') {
	    if (this.options.sortName !== this.options.groupByField) {
	      this.record_views.sort(function (a, b) {
	        return a[that.options.groupByField].localeCompare(b[that.options.groupByField]);
	      });
	    }

	    var groups = groupBy(that.record_views, function (item) {
	  ...
	  if (this.options.groupBy && this.options.groupByField !== '') {
	    ...
	    tableGroups.forEach(function (item) {
	      ...
	      if (typeof that.options.groupByFormatter === 'function') {
	        formattedValue = that.options.groupByFormatter(item.name, item.id, item.record_views);
	      }
	...
	BootstrapTable.prototype.getGroupSelections = function (index) {
	  var that = this;
	  return this.record_views.filter(function (row) {
