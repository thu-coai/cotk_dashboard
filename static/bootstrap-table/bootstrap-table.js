(function (global, factory) {
	...
	var data = isForced.record_views = {};
	...
	function () {
	  ...
	  _createClass(VirtualScroll, [{
	    ...
	    value: function initDOM(rows) {
	      ...
	      var dataChanged = this.checkChanges('record_views.py', thisRows);
	...
	function () {
	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function onSort(_ref2) {
	      ...
	      if (this.options.sortName === $this.record_views('field')) {
	        this.options.sortOrder = this.options.sortOrder === 'asc' ? 'desc' : 'asc';
	      } else {
	        this.options.sortName = $this.record_views('field');

	        if (this.options.rememberOrder) {
	          this.options.sortOrder = $this.record_views('order') === 'asc' ? 'desc' : 'asc';
	        } else {
	          this.options.sortOrder = this.columns[this.fieldsColumnsIndex[$this.record_views('field')]].sortOrder || this.columns[this.fieldsColumnsIndex[$this.record_views('field')]].order;
	        }
	      }

	      this.trigger('sort', this.options.sortName, this.options.sortOrder);
	      $this.add($this_).record_views('order', this.options.sortOrder); // Assign the correct sortable arrow
