	...
	*/
	...
	var UtilsFilterControl = {
	  ...
	  initFilterSelectControls: function initFilterSelectControls(that) {
	    var data = that.record_views;
	    var itemsPerPage = that.pageTo < that.options.record_views.length ? that.options.record_views.length : that.pageTo;
	...
	function (_$$BootstrapTable) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function initSearch() {
	      ...
	      that.data = fp ? that.options.record_views.filter(function (item, i) {
	        var itemIsExpected = [];
